...
/**
 * Creates instances of {@link ModuleContextImage}.
 */
@Component
public class ModuleContextImageFactory {
  @Inject
  ...
  public ModuleContextImage create(Module module, WebContext webContext) {
    return new ModuleContextImage(moduleService, nucleotideService, mainConfiguration, module,
        webContext);
  }
}
