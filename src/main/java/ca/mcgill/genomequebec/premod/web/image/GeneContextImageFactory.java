...
/**
 * Creates instances of {@link GeneContextImage}.
 */
@Component
public class GeneContextImageFactory {
  @Inject
  ...
  public GeneContextImage create(Nucleotide nucleotide, Version version, WebContext webContext) {
    return new GeneContextImage(moduleService, nucleotideService, mainConfiguration, nucleotide,
        version, webContext);
  }
}
