...
/**
 * Tag to write a DNA or protein sequence. Uses line breaks to separate lines, so it's intended to
 * be used inside a &lt;pre&gt; element.
 */
public class SequencePreTag extends SimpleTagSupport {
  /**
